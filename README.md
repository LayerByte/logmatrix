...
Logmatrix is a defensive cybersecurity and system-administration project written in .NET C# WPF. It focuses on read-only analysis, validation, clear output, and safe handling of user-provided files, URLs, hosts, or text.
...
`dotnet run --project Logmatrix.csproj`
